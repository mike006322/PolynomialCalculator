def collect_like_terms(term_matrix, preserve_header=True):
    """
    ...
    # Only include terms where coef is a number and not zero
    import numbers
    collected = []
