...
class TestIdeal(unittest.TestCase):
    ...
    def test_s_polynomial(self):
        ...
        # The result should be -3x^3y^3 + 3x^2 - y^3 (scaled by 3 from the expected result)
        self.assertEqual(Ideal.s_polynomial(f, g), Polynomial("-3x^3y^3 + 3x^2 - y^3"))
    ...
    def test_groebner_basis(self):
        ...
        self.assertEqual(
            I.groebner_basis(),
            [Polynomial("y^3 + -1.0y"), Polynomial("xy^2 + -1.0x"), Polynomial("x^2 + -1.0y")],
        )
    ...
    def test_solve_system(self):
        ...
        I = Ideal(
            ...
            f3,
            f2,
            f1 * f2 * f3 * Polynomial("xyz+y^12+z^13+8"),
            f1 * f2 * f3 * Polynomial("z^12+y^40"),
        )
        # print(f1*f2*f3)
        # print(I.solve_system())
        f1 = Polynomial("x1-1")
        ...
        I = Ideal(
            ...
            f3,
            f2,
            f1 * f2 * f3 * Polynomial("x1+8"),
            f1 * f2 * f3 * Polynomial("x3+10"),
        )
