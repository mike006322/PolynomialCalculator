...
def divides(a, b):
    ...
    if a.term_matrix == [[' ']] or b.term_matrix == [[' ']]:
        return False
    a, b = core.polynomial.Polynomial.combine_variables(a, b)
    a = a.term_matrix
    b = b.term_matrix
    res = True
...
def division_algorithm(input_poly, *others):
    ...
    for i in range(len(others)):
        a.append(core.polynomial.Polynomial(0))
    p = input_poly.copy()
    r = core.polynomial.Polynomial(0)
    while p != core.polynomial.Polynomial(0):
        i = 0
