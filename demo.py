...
from polynomials import Ideal, Polynomial, gcd, lcm
...
def polynomial_calculus():
    ...
    try:
        ...
        print("Critical point solving requires numerical methods for this polynomial")
    ...
    print("\nFactorization:")
    print("f(x) = x(x^2 - 3*x + 2) = x(x - 1)(x - 2)")
    print("Roots: x = 0, 1, 2")
